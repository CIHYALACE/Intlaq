  ...
  <div className="container">
    ...
    <div className="row g-4">
      ...
      <div className="col-md-6 col-lg-4">
        <div className="card h-100 border-0 shadow-sm hover-shadow transition-all">
          <div className="card-body p-4 text-center">
            <div className="bg-info bg-opacity-10 p-3 rounded-circle d-inline-flex mb-4">
              <span className="fs-3">🧠</span>
            </div>
            <h4 className="mb-3">Advanced Filters</h4>
            <p className="text-muted mb-0">
      ...
      <div className="col-md-6 col-lg-4">
        <div className="card h-100 border-0 shadow-sm hover-shadow transition-all">
          <div className="card-body p-4 text-center">
            <div className="bg-warning bg-opacity-10 p-3 rounded-circle d-inline-flex mb-4">
              <span className="fs-3">📬</span>
            </div>
      ...
      <div className="col-md-6 col-lg-4">
        <div className="card h-100 border-0 shadow-sm hover-shadow transition-all">
          <div className="card-body p-4 text-center">
            ...
            <h4 className="mb-3">Tracking Dashboard</h4>
            <p className="text-muted mb-0">
      ...
      <div className="col-md-6 col-lg-4">
        <div className="card h-100 border-0 shadow-sm hover-shadow transition-all">
          <div className="card-body p-4 text-center">
            ...
            <h4 className="mb-3">Secure & Simple</h4>
            <p className="text-muted mb-0">
        ...
        <div className="card h-100 border-0 bg-primary text-white">
          <div className="card-body p-4 d-flex flex-column justify-content-center text-center">
            ...
            <div className="d-grid gap-2">
              <a href="#signup" className="btn btn-light btn-lg">Sign Up Free</a>
              <a href="#demo" className="btn btn-outline-light btn-lg">See Demo</a>
            </div>
          </div>
        </div>
      </div>
